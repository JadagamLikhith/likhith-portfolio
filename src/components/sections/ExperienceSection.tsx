...
export function ExperienceSection() {
  return (
    <section id="experience" className="py-20 sm:py-28 border-t border-border-ghost relative">
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <Card variant="tier1" padding="md" className="border border-border-ghost flex flex-col justify-between">
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-3 pt-2">
                {certificationsData.map((cert) => (
                  <div
                    key={cert.title}
                    className="p-3 rounded-xl bg-surface-2 border border-border-ghost space-y-1"
                  >
